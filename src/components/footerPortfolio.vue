<template>
  <footer class="mt-20 space-y-12 bg-black p-10 text-center text-white">
    <!-- Section Contact -->
    <div>
      <p class="text-xl font-semibold text-orange-500">Contactez-moi !</p>
      <a
        href="mailto:imrane.qrh@gmail.com"
        class="mt-2 block text-xl text-white underline hover:text-orange-400"
      >
    ...
    <!-- Logo -->
    <div>
      <img src="/logo-qrh.svg" alt="QRH Logo" class="mx-auto h-16" />
    </div>
    ...
    <div>
      ...
      <p class="text-xl text-gray-400">© 2024. Imrane QERCHI. Tous droits réservés.</p>
    </div>
  </footer>
</template>
